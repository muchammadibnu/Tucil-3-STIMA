TUCIL STIMA 4 Ekstraksi Informasi dari Artikel Berita dengan Algoritma Pencocokan String
----------------------------------------------------------------------------------------

PREREQUISITES

1.Python
windows: https://docs.python.org/3.6/using/windows.html#installing-without-ui
linux in terminal: sudo apt-get install python3.6
2.library virtualenv
windows: pip install virtualenv
linux: sudo install virtualenv
3.library flask
windows: pip install flask
linux: sudo pip install flask
4.library os
windows: pip install os
linux: sudo pip install os
5.library os.path
windows: pip install os.path
linux: sudo pip install os.path
6.library werkzeug.utils
windows: pip install werkzeug.utils
linux: sudo pip install werkzeug.utils
...
7. jalankan code berikut (python3 app.py) untuk menjalankan servernya
